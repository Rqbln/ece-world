...
void jeu_taupe(){
    ...
    //Taupe
    for (int i = 0; i < 5; i++) {
        sprintf(nomFichier, "../Games/Taupe/images/taupe_%d.bmp",i);

        taupe[i] = load_bitmap(nomFichier, NULL);
    ...
    fond = load_bitmap("../Games/Taupe/images/fond.bmp",NULL);
